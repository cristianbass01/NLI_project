...
from util.generate_metrics_latex_table import device, models_base_directory
import os
...
DIALOGUE_ACT_MODEL_PATH = os.path.join(models_base_directory, '1_predict_domain_and_dialog_act', 'roberta', 'model.pt')
SLOT_FILLING_MODEL_PATH = os.path.join(models_base_directory, '2_slot_filling', 'roberta', '2_1_model_bio_tagging.pt')
QUESTION_TAGS_MODEL_PATH = os.path.join(models_base_directory, '2_slot_filling', 'roberta', '2_2_model_question_labeling.pt')
TO_BE_RETRIEVED_MODEL_PATH = os.path.join(models_base_directory, '3_predict_agent_move', 'roberta', '3_1_model_slots_to_be_retrieved.pt')
AGENT_DIALOGUE_ACT_MODEL_PATH = os.path.join(models_base_directory, '3_predict_agent_move', 'roberta', '3_2_model_agent_dialog_act.pt')
TO_BE_REQUESTED_MODEL_PATH = os.path.join(models_base_directory, '3_predict_agent_move', 'roberta', '3_3_model_slots_to_be_requested.pt')
...
class Agent:
    ...
    def predict_dialogue_act(self):
        ...
        self.history[self.index]['dialogue_act'] = prediction
    ...
    def predict_to_be_retrieved(self):
        ...
        self.history[self.index]['to_be_retrieved'] = prediction
        if prediction != ['none']:
    ...
    def predict_agent_dialogue_act(self):
        ...
        self.history[self.index]['agent_dialogue_act'] = prediction
    ...
    def predict_to_be_requested(self):
        ...
        self.history[self.index]['to_be_requested'] = prediction
        return self.history[self.index]['to_be_requested']
    ...
    def predict_multi_label(self, model, mlb, sentence):
        ...
        # flatten
        outputs = [item for tup in outputs for item in tup]
